#!/bin/bash
# ============================================================================
# Local Deployment Script (Modified from deployment/2-deploy.sh)
# ============================================================================
set -e
...
echo "========================================="
echo "  Max Pay Ads — Local Deployment"
echo "========================================="
...
if [ ! -f "$ENV_FILE" ]; then
  ...
  echo "This file must exist and is intentionally excluded from Git."
  missing=1
fi
