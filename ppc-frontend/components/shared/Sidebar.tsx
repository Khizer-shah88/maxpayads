...
import {
  ...
  ShieldAlert, BarChart3, CreditCard, ClipboardList, LogOut, ChevronLeft, Menu, Zap, KeyRound, Globe2, LayoutTemplate, Link2, ArrowRightLeft,
} from 'lucide-react'
...
const navItems = [
  ...
  { label: 'Redirect Chains', href: '/admin/redirect-chains', icon: ArrowRightLeft },
